...
//
// Solidity: function create(address player, string tokenURI) returns(uint256)
func (_NFT *NFTTransactor) Create(opts *bind.TransactOpts, player common.Address, tokenURI string) (*types.Transaction, error) {
	return _NFT.contract.Transact(opts, "create", player, tokenURI)
}

// Create is a paid mutator transaction binding the contract method 0xa15ab08d.
//
// Solidity: function create(address player, string tokenURI) returns(uint256)
func (_NFT *NFTSession) Create(player common.Address, tokenURI string) (*types.Transaction, error) {
	return _NFT.Contract.Create(&_NFT.TransactOpts, player, tokenURI)
}

// Create is a paid mutator transaction binding the contract method 0xa15ab08d.
//
// Solidity: function create(address player, string tokenURI) returns(uint256)
func (_NFT *NFTTransactorSession) Create(player common.Address, tokenURI string) (*types.Transaction, error) {
	return _NFT.Contract.Create(&_NFT.TransactOpts, player, tokenURI)
}
